...
class EssentialDKPBot(DKPBot):
    ...
    def _configure(self):
        ...
        # Data outputs
        self._single_player_profile_builder = SinglePlayerProfile("Essential DKP Profile", self._timezone)
        ...
        config.dkp.alternative_display_mode, self._timezone)
        ...
        config.dkp_history.alternative_display_mode, self._timezone)
        ...
        config.loot_history.alternative_display_mode, self._timezone)
        ...
        config.latest_loot.alternative_display_mode, self._timezone)
